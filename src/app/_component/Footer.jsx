            ...
            <Wrapper className='pb-2'>
                <div className='grid grid-cols-1 md:grid-cols-4 gap-12 py-2 '>
                    <section className='flex flex-col gap-2'>
                        <Link href='/'>  <Image src='/logowhite.png' width={220} height={60} alt='logo' /></Link>
                    ...
                    <section className='flex flex-col gap-4'>
                        ...
                        <h2 className='flex flex-wrap gap-3 items-center'><IoLocationOutline size={25} /> </h2>
                        <p className='col-span-6'>Plot No.164, Udyog Vihar Phase-6,
                        Gurugram - 122004, Haryana (India) </p>
                        </div>
                        <h2 className='flex  gap-4 items-center'><LuMail size={22} /> hello@domain.com</h2>
